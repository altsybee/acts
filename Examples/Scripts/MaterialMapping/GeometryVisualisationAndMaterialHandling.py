    ...
    for entry in data["Surfaces"]["entries"]:
        if "layer" in entry:
            ...
            if entry["value"]["type"] == "CylinderSurface":
                ...
                print(
                    "WARNING: Processing surface with unknown type '",
                    entry["value"]["type"],
            ...
            if (
                ...
                for val in entry["value"]["material"]["binUtility"]["binningdata"]:
                    if entry["value"]["type"] == "CylinderSurface":
                        ...
                        print(
                            f"WARNING: Processing surface with unknown type '",
                            entry["value"]["type"], "'. Only CylinderSurface and DiscSurface are considered."
                        )
                    if val["bins"] == 0:
                        print(
                            "ERROR!!! Using binning value == 0! Check you input for",
